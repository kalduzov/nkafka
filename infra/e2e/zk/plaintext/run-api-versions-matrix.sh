...
for kafka_version in $KAFKA_VERSIONS; do
  ...
  project_name="nkafka-e2e-zk-plaintext-$version_token"
  container_name="nkafka-e2e-zk-plaintext-$version_token"
  zookeeper_container_name="nkafka-e2e-zk-plaintext-zookeeper-$version_token"
  ...
  printf '\n=== Kafka %s / ZooKeeper plaintext / ApiVersions E2E ===\n' "$kafka_version"
