...
| Tests | [tests/integration](K:\nkafka\tests\integration) | Integration coverage узкое и заметно смещено в admin scenarios | High-risk runtime features недопроверены end-to-end | P1 | Добавить integration tests для producer, consumer, transactions, security |
