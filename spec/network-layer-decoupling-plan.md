...
dotnet test tests/integration/NKafka.IntegrationTests.Kafka_3_9/NKafka.IntegrationTests.Kafka_3_9.csproj --no-restore -f net9.0 --filter "FullyQualifiedName~ClusterDescribeSecurityTests"
```

Recommended targeted filters:

- all security integration entrypoints:
  - `dotnet test tests/integration/NKafka.IntegrationTests.Kafka_3_9/NKafka.IntegrationTests.Kafka_3_9.csproj --no-restore -f net9.0 --filter "Category=SecurityIntegration"`
- only `PLAIN`:
  - `dotnet test tests/integration/NKafka.IntegrationTests.Kafka_3_9/NKafka.IntegrationTests.Kafka_3_9.csproj --no-restore -f net9.0 --filter "SecurityMechanism=PLAIN"`
- only `SCRAM`:
  - `dotnet test tests/integration/NKafka.IntegrationTests.Kafka_3_9/NKafka.IntegrationTests.Kafka_3_9.csproj --no-restore -f net9.0 --filter "SecurityMechanism=SCRAM"`
