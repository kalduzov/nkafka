...
namespace Microlibs.Kafka.Config
{
    public abstract record CommonConfig
    {
        ...
        ///    If set to false, or the ApiVersionRequest fails, the fallback version `broker.version.fallback` will be used. **NOTE**:
        ...
        /// To avoid connection storms, a randomization factor of 0.2 will be applied to the timeout resulting in a random range
        ...
        private static string GetHostName()
        {
            ...
            {
                return $"Microlibs.Kafkf/{Assembly.GetCallingAssembly().GetName().Version}";
            }
        }
    }
}