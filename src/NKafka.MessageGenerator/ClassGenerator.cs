...
//
//     public ClassGenerator(MessageSpecification messageSpecification, IWriteMethodGenerator writeMethodGenerator, IReadMethodGenerator readMethodGenerator)
//     {
...
//         _internalClasses = GetAllInternalClasses(messageSpecification.Fields);
//     }
//
//     public StringBuilder Generate()
//     {
//         return _messageSpecification.Type switch
//         {
//             MessageType.Request or MessageType.Response => GenerateRequestResponseMessage(_messageSpecification.ClassName),
...
//     {
//         var builder = new StringBuilder(_messageSpecification.Name.Length + _EMPTY_CLASS_TEMPLATE.Length);
//
//         builder.AppendFormat(_EMPTY_CLASS_TEMPLATE, _messageSpecification.Name);
//
//         return builder;
//     }
//
...
//
//         var baseClassName = _messageSpecification.Type + "Message";
//         var body = GenerateBody(className, _messageSpecification);
...
//             builder.AppendLine();
//
//             var constructor = GenerateCtor(className, _messageSpecification, true);
...
//
//         IncrementIndent();
//         builder.AppendLine($"{Indent}LowestSupportedVersion = ApiVersions.Version{_messageSpecification.ValidVersions.Lowest};");
//         builder.AppendLine($"{Indent}HighestSupportedVersion = ApiVersions.Version{_messageSpecification.ValidVersions.Highest};");
//         DecrementIndent();
//
//         builder.AppendLine($"{Indent}}}");
//
...
//     {
//         return field.Ignorable || field.Default is not null && field.Default.Equals("null", StringComparison.OrdinalIgnoreCase)
//             ? "?"
//             : string.Empty;
//     }
//
