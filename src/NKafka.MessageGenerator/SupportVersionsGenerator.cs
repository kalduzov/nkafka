...
public class SupportVersionsGenerator
{
        ...
        IEnumerable<(string Name, short ApiKey, Versions FlexibleVersions, Versions Versions)> supportVersionsInformation)
    {
        ...
        _codeGenerator.AppendLine("internal static class SupportVersionsExtensions");
        ...
        GenerateHeaderVersions(versionsInformation);
        _codeGenerator.AppendLine();
        GenerateRequestVersions(versionsInformation);

        _codeGenerator.DecrementIndent();
        _codeGenerator.AppendRightBrace();
    }

    private void GenerateRequestVersions((string Name, short ApiKey, Versions FlexibleVersion, Versions versions)[] supportVersionsInformation)
    {
