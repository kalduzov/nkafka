...
{
    [LoggerMessage(EventId = LogExtensions.PRODUCER_EVENT_BASE_ID,
        Level = LogLevel.Trace,
        Message = LogExtensions.LOGGER_PREFIX + "Starting the Kafka producer {ProducerName}")]
    public static partial void StartProducerTrace(this ILogger logger, string producerName);

    [LoggerMessage(EventId = LogExtensions.PRODUCER_EVENT_BASE_ID + 1,
        Level = LogLevel.Trace,
        Message = LogExtensions.LOGGER_PREFIX + "Kafka producer {ProducerName} started")]
    ...
    [LoggerMessage(EventId = LogExtensions.PRODUCER_EVENT_BASE_ID + 3,
        ...
        Message = LogExtensions.LOGGER_PREFIX + "Topic message producing error {TopicPartition}")]
    public static partial void ProduceMessageError(this ILogger logger, Exception exc, TopicPartition topicPartition);

    [LoggerMessage(EventId = LogExtensions.PRODUCER_EVENT_BASE_ID + 4,
        Level = LogLevel.Trace,
