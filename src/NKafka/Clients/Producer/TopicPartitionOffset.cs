...
public class TopicPartitionOffset
{
    ...
    {
        if (obj is not TopicPartitionOffset topicPartitionOffset)
        {
            return false;
        }

        return topicPartitionOffset.Partition == Partition && topicPartitionOffset.Topic == Topic && topicPartitionOffset.Offset == Offset;
    }
