...
public sealed partial class AllocateProducerIdsResponseMessage: IResponseMessage, IEquatable<AllocateProducerIdsResponseMessage>
{
    ...
    public bool Equals(AllocateProducerIdsResponseMessage? other)
    {
        ...
        if (ProducerIdStart != other.ProducerIdStart)
        {
            return false;
        }
        if (ProducerIdLen != other.ProducerIdLen)
        {
            return false;
        }
