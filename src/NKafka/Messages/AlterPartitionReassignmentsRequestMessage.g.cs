...
public sealed partial class AlterPartitionReassignmentsRequestMessage: IRequestMessage, IEquatable<AlterPartitionReassignmentsRequestMessage>
{
    /// <inheritdoc />
    ...
    public sealed partial class ReassignableTopicMessage: IMessage, IEquatable<ReassignableTopicMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class ReassignablePartitionMessage: IMessage, IEquatable<ReassignablePartitionMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public override string ToString()
        {
            return "ReassignablePartitionMessage("
                ...
                + ", Replicas=" + (Replicas is null ? "null" : Replicas.DeepToString())
                + ")";
        }
    }
}
