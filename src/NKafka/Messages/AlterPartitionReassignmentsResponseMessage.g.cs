...
public sealed partial class AlterPartitionReassignmentsResponseMessage: IResponseMessage, IEquatable<AlterPartitionReassignmentsResponseMessage>
{
    ...
    public sealed partial class ReassignableTopicResponseMessage: IMessage, IEquatable<ReassignableTopicResponseMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class ReassignablePartitionResponseMessage: IMessage, IEquatable<ReassignablePartitionResponseMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
