...
public sealed partial class AlterPartitionRequestMessage: IRequestMessage, IEquatable<AlterPartitionRequestMessage>
{
    /// <inheritdoc />
    ...
    public sealed partial class PartitionDataMessage: IMessage, IEquatable<PartitionDataMessage>
    {
        ...
        public bool Equals(PartitionDataMessage? other)
        {
            ...
            {
                if (!NewIsr.SequenceEqual(other.NewIsr))
                {
                    return false;
                }
            }
