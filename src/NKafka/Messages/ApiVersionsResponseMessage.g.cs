...
public sealed partial class ApiVersionsResponseMessage: IResponseMessage, IEquatable<ApiVersionsResponseMessage>
{
        ...
        if (version >= ApiVersion.Version3)
        {
            ...
            for (var t = 0; t < numTaggedFields; t++)
            {
                ...
                switch (tag)
                {
                    ...
                    case 3:
                    {
                        ZkMigrationReady = reader.ReadByte() != 0;
                        break;
                    }
                    default:
    ...
    public bool Equals(ApiVersionsResponseMessage? other)
    {
        ...
        {
            if (!ApiKeys.SequenceEqual(other.ApiKeys))
            {
                return false;
            }
        }
        ...
        {
            if (other.SupportedFeatures is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!SupportedFeatures.SequenceEqual(other.SupportedFeatures))
            {
                return false;
            }
        }
        if (FinalizedFeaturesEpoch != other.FinalizedFeaturesEpoch)
        {
            return false;
        }
        if (FinalizedFeatures is null)
        {
            if (other.FinalizedFeatures is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!FinalizedFeatures.SequenceEqual(other.FinalizedFeatures))
            {
                return false;
            }
        }
        if (ZkMigrationReady != other.ZkMigrationReady)
        {
            return false;
        }
    ...
    {
        var hashCode = 0;
        hashCode = HashCode.Combine(hashCode, ErrorCode, ApiKeys, ThrottleTimeMs, SupportedFeatures, FinalizedFeaturesEpoch, FinalizedFeatures, ZkMigrationReady);
        return hashCode;
    }
    ...
    public override string ToString()
    {
        return "ApiVersionsResponseMessage("
            + "ErrorCode=" + ErrorCode
            + ", ApiKeys=" + ApiKeys.DeepToString()
            + ", ThrottleTimeMs=" + ThrottleTimeMs
            + ", SupportedFeatures=" + SupportedFeatures.DeepToString()
            + ", FinalizedFeaturesEpoch=" + FinalizedFeaturesEpoch
            + ", FinalizedFeatures=" + FinalizedFeatures.DeepToString()
    ...
    public sealed partial class FinalizedFeatureKeyMessage: IMessage, IEquatable<FinalizedFeatureKeyMessage>
    {
        ...
        public bool Equals(FinalizedFeatureKeyMessage? other)
        {
            ...
            if (MaxVersionLevel != other.MaxVersionLevel)
            {
                return false;
            }
            if (MinVersionLevel != other.MinVersionLevel)
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
