...
public sealed partial class BrokerHeartbeatRequestMessage: IRequestMessage, IEquatable<BrokerHeartbeatRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(BrokerHeartbeatRequestMessage? other)
    {
        ...
        if (CurrentMetadataOffset != other.CurrentMetadataOffset)
        {
            return false;
        }
        if (WantFence != other.WantFence)
        {
            return false;
        }
        if (WantShutDown != other.WantShutDown)
        {
            return false;
        }
