...
public sealed partial class BrokerHeartbeatResponseMessage: IResponseMessage, IEquatable<BrokerHeartbeatResponseMessage>
{
    ...
    public bool Equals(BrokerHeartbeatResponseMessage? other)
    {
        ...
        if (IsCaughtUp != other.IsCaughtUp)
        {
            return false;
        }
        ...
        if (ShouldShutDown != other.ShouldShutDown)
        {
            return false;
        }
