...
internal sealed partial class DeleteAclsResponseMessage: IResponseMessage, IEquatable<DeleteAclsResponseMessage>
{
    ...
    public void Write(ref BufferWriter writer, ApiVersion version)
    {
        ...
        if (version >= ApiVersion.Version2)
        {
            writer.WriteVarUInt32(FilterResults.Count + 1);
    ...
    public bool Equals(DeleteAclsResponseMessage? other)
    {
        ...
        {
            if (other.FilterResults is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!FilterResults.SequenceEqual(other.FilterResults))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "DeleteAclsResponseMessage("
            ...
            + ", FilterResults=" + FilterResults.DeepToString()
            + ")";
    }
    ...
    internal sealed partial class DeleteAclsFilterResultMessage: IMessage, IEquatable<DeleteAclsFilterResultMessage>
    {
        ...
        public void Write(ref BufferWriter writer, ApiVersion version)
        {
            ...
            if (version >= ApiVersion.Version2)
            {
                writer.WriteVarUInt32(MatchingAcls.Count + 1);
        ...
        public bool Equals(DeleteAclsFilterResultMessage? other)
        {
            ...
            if (MatchingAcls is null)
            {
                if (other.MatchingAcls is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!MatchingAcls.SequenceEqual(other.MatchingAcls))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "DeleteAclsFilterResultMessage("
                ...
                + ", MatchingAcls=" + MatchingAcls.DeepToString()
                + ")";
        }
    }
