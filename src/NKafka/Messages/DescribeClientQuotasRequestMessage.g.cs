...
public sealed partial class DescribeClientQuotasRequestMessage: IRequestMessage, IEquatable<DescribeClientQuotasRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(DescribeClientQuotasRequestMessage? other)
    {
        ...
        {
            if (!Components.SequenceEqual(other.Components))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "DescribeClientQuotasRequestMessage("
            + "Components=" + Components.DeepToString()
            + ", Strict=" + (Strict ? "true" : "false")
            + ")";
    }

    public sealed partial class ComponentDataMessage: IMessage, IEquatable<ComponentDataMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public override string ToString()
        {
            return "ComponentDataMessage("
                ...
                + ", MatchType=" + MatchType
                + ", Match=" + (string.IsNullOrWhiteSpace(Match) ? "null" : Match)
                + ")";
        }
    }
}
