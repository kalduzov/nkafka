...
public sealed partial class DescribeClientQuotasResponseMessage: IResponseMessage, IEquatable<DescribeClientQuotasResponseMessage>
{
    ...
    public override string ToString()
    {
        return "DescribeClientQuotasResponseMessage("
            ...
            + ", Entries=" + (Entries is null ? "null" : Entries.DeepToString())
            + ")";
    }
    ...
    public sealed partial class ValueDataMessage: IMessage, IEquatable<ValueDataMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
