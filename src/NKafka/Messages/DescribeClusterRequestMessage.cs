...
public sealed class DescribeClusterRequestMessage: IRequestMessage, IEquatable<DescribeClusterRequestMessage>
{
    ...
    public DescribeClusterRequestMessage(BufferReader reader, ApiVersion version)
        : this()
    {
        Read(reader, version);
    }
