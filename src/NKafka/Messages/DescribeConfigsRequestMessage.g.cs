//69-2C-BD-35-11-D7-8A-D9-CF-BB-D7-6B-A0-2C-A0-65-A6-A3-2B-2B-27-AA-16-8F-BD-1B-64-32-E4-1F-30-70
...
internal sealed partial class DescribeConfigsRequestMessage: IRequestMessage, IEquatable<DescribeConfigsRequestMessage>
{
    ...
    public void Write(ref BufferWriter writer, ApiVersion version)
    {
        ...
        if (version >= ApiVersion.Version4)
        {
            writer.WriteVarUInt32(Resources.Count + 1);
    ...
    public bool Equals(DescribeConfigsRequestMessage? other)
    {
        ...
        if (IncludeSynonyms != other.IncludeSynonyms)
        {
            return false;
        }
        if (IncludeDocumentation != other.IncludeDocumentation)
        {
            return false;
        }
    ...
    internal sealed partial class DescribeConfigsResourceMessage: IMessage, IEquatable<DescribeConfigsResourceMessage>
    {
        ...
        public void Write(ref BufferWriter writer, ApiVersion version)
        {
            ...
            if (version >= ApiVersion.Version4)
            {
                ...
                {
                    writer.WriteVarUInt32(ConfigurationKeys.Count + 1);
        ...
        public bool Equals(DescribeConfigsResourceMessage? other)
        {
            ...
            if (ConfigurationKeys is null)
            {
                if (other.ConfigurationKeys is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!ConfigurationKeys.SequenceEqual(other.ConfigurationKeys))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "DescribeConfigsResourceMessage("
                ...
                + ", ConfigurationKeys=" + (ConfigurationKeys is null ? "null" : ConfigurationKeys.DeepToString())
                + ")";
        }
    }
}
