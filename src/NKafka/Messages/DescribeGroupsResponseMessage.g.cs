//93-9A-59-B7-E0-02-38-4A-59-95-87-8A-25-2D-E2-6F-EC-C7-48-36-4A-58-4B-5F-FB-EF-7C-FA-AB-45-E6-EE
...
/// </summary>
internal sealed partial class DescribeGroupsResponseMessage: IResponseMessage, IEquatable<DescribeGroupsResponseMessage>
{
    /// <inheritdoc />
    ...
    internal sealed partial class DescribedGroupMessage: IMessage, IEquatable<DescribedGroupMessage>
    {
        ...
        public bool Equals(DescribedGroupMessage? other)
        {
            ...
            if (ProtocolData is null)
            {
                if (other.ProtocolData is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!ProtocolData.Equals(other.ProtocolData))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "DescribedGroupMessage("
                ...
                + ", ProtocolData=" + (string.IsNullOrWhiteSpace(ProtocolData) ? "null" : ProtocolData)
    ...
    /// </summary>
    internal sealed partial class DescribedGroupMemberMessage: IMessage, IEquatable<DescribedGroupMemberMessage>
    {
        /// <inheritdoc />
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public void Write(ref BufferWriter writer, ApiVersion version)
        {
            ...
            if (version >= ApiVersion.Version5)
            {
                writer.WriteVarUInt32(MemberMetadata.Length + 1);
            }
            else
            {
            ...
            if (version >= ApiVersion.Version5)
            {
                writer.WriteVarUInt32(MemberAssignment.Length + 1);
            }
            else
            {
        ...
        public bool Equals(DescribedGroupMemberMessage? other)
        {
            ...
            if (!MemberMetadata.SequenceEqual(other.MemberMetadata))
            {
                return false;
            }
            if (!MemberAssignment.SequenceEqual(other.MemberAssignment))
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
        ...
        public override string ToString()
        {
            return "DescribedGroupMemberMessage("
                ...
                + ", MemberMetadata=" + MemberMetadata.DeepToString()
                + ", MemberAssignment=" + MemberAssignment.DeepToString()
                + ")";
        }
    }
}
