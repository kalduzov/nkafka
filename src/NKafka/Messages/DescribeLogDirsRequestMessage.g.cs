...
public sealed partial class DescribeLogDirsRequestMessage: IRequestMessage, IEquatable<DescribeLogDirsRequestMessage>
{
    /// <inheritdoc />
    ...
    public sealed partial class DescribableLogDirTopicMessage: IMessage, IEquatable<DescribableLogDirTopicMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class DescribableLogDirTopicCollection: HashSet<DescribableLogDirTopicMessage>
    {
        ...
        public override bool Equals(object? obj)
        {
            return SetEquals((IEnumerable<DescribableLogDirTopicMessage>)obj);
        }
    }
}
