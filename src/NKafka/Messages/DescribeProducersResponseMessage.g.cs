...
public sealed partial class DescribeProducersResponseMessage: IResponseMessage, IEquatable<DescribeProducersResponseMessage>
{
    ...
    public sealed partial class TopicResponseMessage: IMessage, IEquatable<TopicResponseMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class PartitionResponseMessage: IMessage, IEquatable<PartitionResponseMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(PartitionResponseMessage? other)
        {
            ...
            {
                if (other.ActiveProducers is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!ActiveProducers.SequenceEqual(other.ActiveProducers))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "PartitionResponseMessage("
                ...
                + ", ActiveProducers=" + ActiveProducers.DeepToString()
                + ")";
        }
    }

    public sealed partial class ProducerStateMessage: IMessage, IEquatable<ProducerStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(ProducerStateMessage? other)
        {
            ...
            if (CurrentTxnStartOffset != other.CurrentTxnStartOffset)
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
