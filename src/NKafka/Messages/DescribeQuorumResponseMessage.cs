...
public partial class DescribeQuorumResponseMessage: ResponseMessage
{
    /// <summary>
    ...
    public class PartitionDataMessage: Message
    {
        ...
        /// 
        /// </summary>
        public IReadOnlyCollection<ReplicaStateMessage> CurrentVoters { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public IReadOnlyCollection<ReplicaStateMessage> Observers { get; set; }
    ...
    public class ReplicaStateMessage: Message
    {
