...
public sealed partial class DescribeQuorumResponseMessage: IResponseMessage, IEquatable<DescribeQuorumResponseMessage>
{
    ...
    public sealed partial class PartitionDataMessage: IMessage, IEquatable<PartitionDataMessage>
    {
        ...
        public bool Equals(PartitionDataMessage? other)
        {
            ...
            if (CurrentVoters is null)
            {
                if (other.CurrentVoters is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!CurrentVoters.SequenceEqual(other.CurrentVoters))
                {
                    return false;
                }
            }
            ...
            {
                if (other.Observers is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!Observers.SequenceEqual(other.Observers))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "PartitionDataMessage("
                ...
                + ", CurrentVoters=" + CurrentVoters.DeepToString()
                + ", Observers=" + Observers.DeepToString()
                + ")";
        }
    }
    ...
    public sealed partial class ReplicaStateMessage: IMessage, IEquatable<ReplicaStateMessage>
    {
        ...
        public bool Equals(ReplicaStateMessage? other)
        {
            ...
            if (LogEndOffset != other.LogEndOffset)
            {
                return false;
            }
            if (LastFetchTimestamp != other.LastFetchTimestamp)
            {
                return false;
            }
            if (LastCaughtUpTimestamp != other.LastCaughtUpTimestamp)
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
