...
public sealed partial class DescribeTransactionsResponseMessage: IResponseMessage, IEquatable<DescribeTransactionsResponseMessage>
{
    ...
    public sealed partial class TransactionStateMessage: IMessage, IEquatable<TransactionStateMessage>
    {
        ...
        public bool Equals(TransactionStateMessage? other)
        {
            ...
            if (TransactionStartTimeMs != other.TransactionStartTimeMs)
            {
                return false;
            }
    ...
    public sealed partial class TopicDataCollection: HashSet<TopicDataMessage>
    {
        ...
        public override bool Equals(object? obj)
        {
            return SetEquals((IEnumerable<TopicDataMessage>)obj);
        }
    }
}
