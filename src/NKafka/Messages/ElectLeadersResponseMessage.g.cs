...
public sealed partial class ElectLeadersResponseMessage: IResponseMessage, IEquatable<ElectLeadersResponseMessage>
{
    ...
    public bool Equals(ElectLeadersResponseMessage? other)
    {
        ...
        if (ReplicaElectionResults is null)
        {
            if (other.ReplicaElectionResults is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!ReplicaElectionResults.SequenceEqual(other.ReplicaElectionResults))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "ElectLeadersResponseMessage("
            ...
            + ", ErrorCode=" + ErrorCode
            + ", ReplicaElectionResults=" + ReplicaElectionResults.DeepToString()
            + ")";
    }

    public sealed partial class ReplicaElectionResultMessage: IMessage, IEquatable<ReplicaElectionResultMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(ReplicaElectionResultMessage? other)
        {
            ...
            {
                if (other.PartitionResult is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!PartitionResult.SequenceEqual(other.PartitionResult))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "ReplicaElectionResultMessage("
                ...
                + ", PartitionResult=" + PartitionResult.DeepToString()
                + ")";
        }
    }

    public sealed partial class PartitionResultMessage: IMessage, IEquatable<PartitionResultMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
