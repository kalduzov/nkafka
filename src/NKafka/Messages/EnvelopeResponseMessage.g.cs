...
public sealed partial class EnvelopeResponseMessage: IResponseMessage, IEquatable<EnvelopeResponseMessage>
{
    ...
    public bool Equals(EnvelopeResponseMessage? other)
    {
        ...
        if (!ResponseData.SequenceEqual(other.ResponseData))
        {
            return false;
        }
    ...
    public override string ToString()
    {
        return "EnvelopeResponseMessage("
            + "ResponseData=" + (ResponseData is null ? "null" : ResponseData.DeepToString())
            + ", ErrorCode=" + ErrorCode
            + ")";
    }
}
