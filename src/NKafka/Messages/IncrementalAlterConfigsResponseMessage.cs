...
public sealed class IncrementalAlterConfigsResponseMessage: IResponseMessage, IEquatable<IncrementalAlterConfigsResponseMessage>
{
    ...
    public IncrementalAlterConfigsResponseMessage(BufferReader reader, ApiVersion version)
        : this()
    {
        Read(reader, version);
    }
    ...
    {
        return "IncrementalAlterConfigsResponseMessage("
