//2B-11-B2-54-E7-A1-39-3D-F3-B6-9F-50-6C-94-7B-2B-66-6B-0B-FD-C8-CD-A7-5D-5C-5B-7F-CB-59-F8-A5-36
...
internal sealed partial class JoinGroupRequestMessage: IRequestMessage, IEquatable<JoinGroupRequestMessage>
{
    ...
    public bool Equals(JoinGroupRequestMessage? other)
    {
        ...
        if (SessionTimeoutMs != other.SessionTimeoutMs)
        {
            return false;
        }
        ...
        {
            if (other.Protocols is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!Protocols.SequenceEqual(other.Protocols))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "JoinGroupRequestMessage("
            ...
            + ", Protocols=" + Protocols.DeepToString()
    ...
    internal sealed partial class JoinGroupRequestProtocolMessage: IMessage, IEquatable<JoinGroupRequestProtocolMessage>
    {
        ...
        public bool Equals(JoinGroupRequestProtocolMessage? other)
        {
            ...
            if (!Metadata.SequenceEqual(other.Metadata))
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
        ...
        public override string ToString()
        {
            return "JoinGroupRequestProtocolMessage("
                ...
                + ", Metadata=" + Metadata.DeepToString()
                + ")";
        }
    }
