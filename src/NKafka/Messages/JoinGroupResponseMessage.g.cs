...
internal sealed partial class JoinGroupResponseMessage: IResponseMessage, IEquatable<JoinGroupResponseMessage>
{
    ...
    public void Write(ref BufferWriter writer, ApiVersion version)
    {
        ...
        else
        {
            ...
            {
                writer.WriteInt16String(ProtocolName);
            }
        }
        {
            if (version >= ApiVersion.Version6)
            ...
            {
                writer.WriteInt16String(Leader);
            }
        }
        if (version >= ApiVersion.Version9)
        {
    ...
    public bool Equals(JoinGroupResponseMessage? other)
    {
        ...
        if (SkipAssignment != other.SkipAssignment)
        {
            return false;
        }
        if (MemberId is null)
    ...
    public override string ToString()
    {
        return "JoinGroupResponseMessage("
            ...
            + ", Leader=" + (string.IsNullOrWhiteSpace(Leader) ? "null" : Leader)
