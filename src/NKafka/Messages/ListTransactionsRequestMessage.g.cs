...
public sealed partial class ListTransactionsRequestMessage: IRequestMessage, IEquatable<ListTransactionsRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(ListTransactionsRequestMessage? other)
    {
        ...
        {
            if (other.StateFilters is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!StateFilters.SequenceEqual(other.StateFilters))
            {
                return false;
            }
        }
        ...
        {
            if (other.ProducerIdFilters is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!ProducerIdFilters.SequenceEqual(other.ProducerIdFilters))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "ListTransactionsRequestMessage("
            + "StateFilters=" + StateFilters.DeepToString()
            + ", ProducerIdFilters=" + ProducerIdFilters.DeepToString()
            + ")";
    }
}
