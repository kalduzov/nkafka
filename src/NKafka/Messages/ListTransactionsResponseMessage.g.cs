...
public sealed partial class ListTransactionsResponseMessage: IResponseMessage, IEquatable<ListTransactionsResponseMessage>
{
    ...
    public bool Equals(ListTransactionsResponseMessage? other)
    {
        ...
        {
            if (other.UnknownStateFilters is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!UnknownStateFilters.SequenceEqual(other.UnknownStateFilters))
            {
                return false;
            }
        }
        if (TransactionStates is null)
        {
            if (other.TransactionStates is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!TransactionStates.SequenceEqual(other.TransactionStates))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "ListTransactionsResponseMessage("
            ...
            + ", ErrorCode=" + ErrorCode
            + ", UnknownStateFilters=" + UnknownStateFilters.DeepToString()
            + ", TransactionStates=" + TransactionStates.DeepToString()
            + ")";
    }

    public sealed partial class TransactionStateMessage: IMessage, IEquatable<TransactionStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(TransactionStateMessage? other)
        {
            ...
            {
                if (other.TransactionState is not null)
                {
                    return false;
                }
            }
            ...
            {
                if (!TransactionState.Equals(other.TransactionState))
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "TransactionStateMessage("
                ...
                + ", TransactionState=" + (string.IsNullOrWhiteSpace(TransactionState) ? "null" : TransactionState)
                + ")";
        }
    }
}
