...
public sealed partial class RenewDelegationTokenRequestMessage: IRequestMessage, IEquatable<RenewDelegationTokenRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(RenewDelegationTokenRequestMessage? other)
    {
        ...
        if (RenewPeriodMs != other.RenewPeriodMs)
        {
            return false;
        }
