...
public sealed partial class StopReplicaRequestMessage: IRequestMessage, IEquatable<StopReplicaRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(StopReplicaRequestMessage? other)
    {
        ...
        if (DeletePartitions != other.DeletePartitions)
        {
            return false;
        }
        if (UngroupedPartitions is null)
        {
            if (other.UngroupedPartitions is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!UngroupedPartitions.SequenceEqual(other.UngroupedPartitions))
            {
                return false;
            }
        }
    ...
    {
        var hashCode = 0;
        hashCode = HashCode.Combine(hashCode, ControllerId, isKRaftController, ControllerEpoch, BrokerEpoch, DeletePartitions, UngroupedPartitions, Topics);
        hashCode = HashCode.Combine(hashCode, TopicStates);
        return hashCode;
    }
    ...
    public override string ToString()
    {
        return "StopReplicaRequestMessage("
            ...
            + ", UngroupedPartitions=" + UngroupedPartitions.DeepToString()
            + ", Topics=" + Topics.DeepToString()
            + ", TopicStates=" + TopicStates.DeepToString()
            + ")";
    }

    public sealed partial class StopReplicaPartitionV0Message: IMessage, IEquatable<StopReplicaPartitionV0Message>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class StopReplicaTopicV1Message: IMessage, IEquatable<StopReplicaTopicV1Message>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class StopReplicaTopicStateMessage: IMessage, IEquatable<StopReplicaTopicStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class StopReplicaPartitionStateMessage: IMessage, IEquatable<StopReplicaPartitionStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(StopReplicaPartitionStateMessage? other)
        {
            ...
            if (DeletePartition != other.DeletePartition)
            {
                return false;
            }
            return UnknownTaggedFields.CompareRawTaggedFields(other.UnknownTaggedFields);
