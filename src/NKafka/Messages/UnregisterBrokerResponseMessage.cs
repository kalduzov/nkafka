...
public sealed class UnregisterBrokerResponseMessage: IResponseMessage, IEquatable<UnregisterBrokerResponseMessage>
{
    ...
    public UnregisterBrokerResponseMessage(BufferReader reader, ApiVersion version)
        : this()
    {
        Read(reader, version);
    }
