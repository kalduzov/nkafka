...
public sealed partial class UpdateFeaturesRequestMessage: IRequestMessage, IEquatable<UpdateFeaturesRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(UpdateFeaturesRequestMessage? other)
    {
        ...
        {
            if (other.FeatureUpdates is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!FeatureUpdates.SequenceEqual(other.FeatureUpdates))
            {
                return false;
            }
        }
    ...
    public override string ToString()
    {
        return "UpdateFeaturesRequestMessage("
            + "timeoutMs=" + timeoutMs
            + ", FeatureUpdates=" + FeatureUpdates.DeepToString()
            + ", ValidateOnly=" + (ValidateOnly ? "true" : "false")
            + ")";
    }

    public sealed partial class FeatureUpdateKeyMessage: IMessage, IEquatable<FeatureUpdateKeyMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(FeatureUpdateKeyMessage? other)
        {
            ...
            if (AllowDowngrade != other.AllowDowngrade)
            {
                return false;
            }
    ...
    public sealed partial class FeatureUpdateKeyCollection: HashSet<FeatureUpdateKeyMessage>
    {
        ...
        public override bool Equals(object? obj)
        {
            return SetEquals((IEnumerable<FeatureUpdateKeyMessage>)obj);
        }
    }
}
