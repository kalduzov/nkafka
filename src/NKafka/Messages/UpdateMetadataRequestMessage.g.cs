...
public sealed partial class UpdateMetadataRequestMessage: IRequestMessage, IEquatable<UpdateMetadataRequestMessage>
{
    /// <inheritdoc />
    ...
    public bool Equals(UpdateMetadataRequestMessage? other)
    {
        ...
        if (LiveBrokers is null)
        {
            if (other.LiveBrokers is not null)
            {
                return false;
            }
        }
        ...
        {
            if (!LiveBrokers.SequenceEqual(other.LiveBrokers))
            {
                return false;
            }
        }
    ...
    {
        var hashCode = 0;
        hashCode = HashCode.Combine(hashCode, ControllerId, isKRaftController, ControllerEpoch, BrokerEpoch, UngroupedPartitionStates, TopicStates, LiveBrokers);
        return hashCode;
    }
    ...
    public override string ToString()
    {
        return "UpdateMetadataRequestMessage("
            ...
            + ", LiveBrokers=" + LiveBrokers.DeepToString()
            + ")";
    }

    public sealed partial class UpdateMetadataTopicStateMessage: IMessage, IEquatable<UpdateMetadataTopicStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
    ...
    public sealed partial class UpdateMetadataBrokerMessage: IMessage, IEquatable<UpdateMetadataBrokerMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public bool Equals(UpdateMetadataBrokerMessage? other)
        {
            ...
            {
                if (!V0Host.Equals(other.V0Host))
                {
                    return false;
                }
            }
            if (V0Port != other.V0Port)
            {
                return false;
            }
            if (Endpoints is null)
            {
                if (other.Endpoints is not null)
                {
                    return false;
                }
            }
        ...
        public override string ToString()
        {
            return "UpdateMetadataBrokerMessage("
                + "Id=" + Id
                + ", V0Host=" + (string.IsNullOrWhiteSpace(V0Host) ? "null" : V0Host)
                + ", V0Port=" + V0Port
                + ", Endpoints=" + Endpoints.DeepToString()
                + ", Rack=" + (string.IsNullOrWhiteSpace(Rack) ? "null" : Rack)
                + ")";
        }
    }

    public sealed partial class UpdateMetadataEndpointMessage: IMessage, IEquatable<UpdateMetadataEndpointMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
        ...
        public override string ToString()
        {
            return "UpdateMetadataEndpointMessage("
                ...
                + ", Listener=" + (string.IsNullOrWhiteSpace(Listener) ? "null" : Listener)
                + ", SecurityProtocol=" + SecurityProtocol
                + ")";
        }
    }

    public sealed partial class UpdateMetadataPartitionStateMessage: IMessage, IEquatable<UpdateMetadataPartitionStateMessage>
    {
        public List<TaggedField>? UnknownTaggedFields { get; set; } = null;
