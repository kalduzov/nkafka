...
public sealed partial class VoteRequestMessage: IRequestMessage, IEquatable<VoteRequestMessage>
{
    /// <inheritdoc />
    ...
    public sealed partial class PartitionDataMessage: IMessage, IEquatable<PartitionDataMessage>
    {
        ...
        public bool Equals(PartitionDataMessage? other)
        {
            ...
            if (CandidateEpoch != other.CandidateEpoch)
            {
                return false;
            }
            ...
            if (LastOffsetEpoch != other.LastOffsetEpoch)
            {
                return false;
            }
