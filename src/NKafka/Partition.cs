...
{
    private const int _RD_KAFKA_PARTITION_UA = -1;

    /// <summary>
    ///     A special value that refers to an unspecified / unknown partition.
    /// </summary>
    public static readonly Partition Any = new(_RD_KAFKA_PARTITION_UA);
    ...
    ///     partition values.
    /// </summary>
    public bool IsSpecial => Value == _RD_KAFKA_PARTITION_UA;
