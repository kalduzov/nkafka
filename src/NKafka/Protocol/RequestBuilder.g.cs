    ...
    public static IRequestMessage Build(ApiKeys apiKey, ApiVersion apiVersion, byte[] span)
    {
        ...
        try
        {
            ...
            return apiKey switch
            {
                ...
                ApiKeys.AlterShareGroupOffsets => new AlterShareGroupOffsetsRequestMessage(ref reader, apiVersion),
                ...
                ApiKeys.ConsumerGroupDescribe => new ConsumerGroupDescribeRequestMessage(ref reader, apiVersion),
                ...
                ApiKeys.DeleteShareGroupOffsets => new DeleteShareGroupOffsetsRequestMessage(ref reader, apiVersion),
                ...
                ApiKeys.DescribeCluster => new DescribeClusterRequestMessage(ref reader, apiVersion),
                ...
                ApiKeys.DescribeShareGroupOffsets => new DescribeShareGroupOffsetsRequestMessage(ref reader, apiVersion),
                ...
                ApiKeys.ListConfigResources => new ListConfigResourcesRequestMessage(ref reader, apiVersion),
