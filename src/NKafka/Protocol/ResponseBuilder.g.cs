    ...
    public static IResponseMessage Build(ApiKeys apiKey, ApiVersion apiVersion, byte[] span)
    {
        ...
        try
        {
            ...
            return apiKey switch
            {
                ...
                ApiKeys.AlterShareGroupOffsets => new AlterShareGroupOffsetsResponseMessage(ref reader, apiVersion),
                ...
                ApiKeys.ConsumerGroupDescribe => new ConsumerGroupDescribeResponseMessage(ref reader, apiVersion),
                ...
                ApiKeys.DeleteShareGroupOffsets => new DeleteShareGroupOffsetsResponseMessage(ref reader, apiVersion),
                ...
                ApiKeys.DescribeCluster => new DescribeClusterResponseMessage(ref reader, apiVersion),
                ...
                ApiKeys.DescribeShareGroupOffsets => new DescribeShareGroupOffsetsResponseMessage(ref reader, apiVersion),
                ...
                ApiKeys.ListConfigResources => new ListConfigResourcesResponseMessage(ref reader, apiVersion),
