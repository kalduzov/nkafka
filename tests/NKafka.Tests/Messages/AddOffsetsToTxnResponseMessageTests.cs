...
public class AddOffsetsToTxnResponseMessageTests: ResponseMessageTests<AddOffsetsToTxnResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'AddOffsetsToTxnResponseMessage' message")]
