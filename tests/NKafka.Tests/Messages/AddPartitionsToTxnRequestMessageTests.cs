...
public class AddPartitionsToTxnRequestMessageTests: RequestMessageTests<AddPartitionsToTxnRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'AddPartitionsToTxnRequestMessage' message")]
