...
public class AddPartitionsToTxnResponseMessageTests: ResponseMessageTests<AddPartitionsToTxnResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'AddPartitionsToTxnResponseMessage' message")]
