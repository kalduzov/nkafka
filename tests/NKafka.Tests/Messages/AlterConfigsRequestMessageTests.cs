...
public class AlterConfigsRequestMessageTests: RequestMessageTests<AlterConfigsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'AlterConfigsRequestMessage' message")]
    ...
    {
        var message = new AlterConfigsRequestMessage
        {
        };
