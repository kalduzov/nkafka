...
public class AlterConfigsResponseMessageTests: ResponseMessageTests<AlterConfigsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'AlterConfigsResponseMessage' message")]
    ...
    {
        var message = new AlterConfigsResponseMessage
        {
        };
