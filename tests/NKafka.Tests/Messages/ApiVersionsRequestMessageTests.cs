...
public class ApiVersionsRequestMessageTests: RequestMessageTests<ApiVersionsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ApiVersionsRequestMessage' message")]
