...
public sealed partial class BeginQuorumEpochRequestMessageTests: RequestMessageTests<BeginQuorumEpochRequestMessage>
{
    [Fact(DisplayName = "Check serialize and deserialize 'BeginQuorumEpochRequestMessage' message by Version0")]
