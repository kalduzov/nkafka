...
public class ControlledShutdownRequestMessageTests: RequestMessageTests<ControlledShutdownRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ControlledShutdownRequestMessage' message")]
    ...
    {
        var message = new ControlledShutdownRequestMessage
        {
        };
