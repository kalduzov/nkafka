...
public class ControlledShutdownResponseMessageTests: ResponseMessageTests<ControlledShutdownResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ControlledShutdownResponseMessage' message")]
    ...
    {
        var message = new ControlledShutdownResponseMessage
        {
        };
