...
public class CreateAclsRequestMessageTests: RequestMessageTests<CreateAclsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreateAclsRequestMessage' message")]
