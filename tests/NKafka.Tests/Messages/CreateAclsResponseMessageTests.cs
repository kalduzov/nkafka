...
public class CreateAclsResponseMessageTests: ResponseMessageTests<CreateAclsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreateAclsResponseMessage' message")]
    ...
    {
        var message = new CreateAclsResponseMessage
        {
        };
