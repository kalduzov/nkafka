...
public class CreatePartitionsRequestMessageTests: RequestMessageTests<CreatePartitionsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreatePartitionsRequestMessage' message")]
    ...
    {
        var message = new CreatePartitionsRequestMessage
        {
        };
