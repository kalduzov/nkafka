...
public class CreatePartitionsResponseMessageTests: ResponseMessageTests<CreatePartitionsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreatePartitionsResponseMessage' message")]
    ...
    {
        var message = new CreatePartitionsResponseMessage
        {
        };
