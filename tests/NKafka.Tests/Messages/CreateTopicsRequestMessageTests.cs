...
public class CreateTopicsRequestMessageTests: RequestMessageTests<CreateTopicsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreateTopicsRequestMessage' message")]
