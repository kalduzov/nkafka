...
public class CreateTopicsResponseMessageTests: ResponseMessageTests<CreateTopicsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'CreateTopicsResponseMessage' message")]
