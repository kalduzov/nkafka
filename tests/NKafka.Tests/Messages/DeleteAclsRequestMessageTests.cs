...
public class DeleteAclsRequestMessageTests: RequestMessageTests<DeleteAclsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DeleteAclsRequestMessage' message")]
    ...
    {
        var message = new DeleteAclsRequestMessage
        {
        };
