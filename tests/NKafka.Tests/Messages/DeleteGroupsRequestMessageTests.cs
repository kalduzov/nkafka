...
public class DeleteGroupsRequestMessageTests: RequestMessageTests<DeleteGroupsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DeleteGroupsRequestMessage' message")]
