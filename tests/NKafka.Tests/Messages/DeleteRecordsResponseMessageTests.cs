...
public class DeleteRecordsResponseMessageTests: ResponseMessageTests<DeleteRecordsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DeleteRecordsResponseMessage' message")]
    ...
    {
        var message = new DeleteRecordsResponseMessage
        {
        };
