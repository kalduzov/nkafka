...
public class DeleteTopicsRequestMessageTests: RequestMessageTests<DeleteTopicsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DeleteTopicsRequestMessage' message")]
