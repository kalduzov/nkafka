...
public class DeleteTopicsResponseMessageTests: ResponseMessageTests<DeleteTopicsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DeleteTopicsResponseMessage' message")]
