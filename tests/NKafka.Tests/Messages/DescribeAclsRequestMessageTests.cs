...
public class DescribeAclsRequestMessageTests: RequestMessageTests<DescribeAclsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeAclsRequestMessage' message")]
