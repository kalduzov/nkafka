...
public class DescribeAclsResponseMessageTests: ResponseMessageTests<DescribeAclsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeAclsResponseMessage' message")]
