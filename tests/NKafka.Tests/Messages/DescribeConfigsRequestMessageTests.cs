...
public class DescribeConfigsRequestMessageTests: RequestMessageTests<DescribeConfigsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeConfigsRequestMessage' message")]
