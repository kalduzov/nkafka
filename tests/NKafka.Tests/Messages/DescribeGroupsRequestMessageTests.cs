...
public class DescribeGroupsRequestMessageTests: RequestMessageTests<DescribeGroupsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeGroupsRequestMessage' message")]
