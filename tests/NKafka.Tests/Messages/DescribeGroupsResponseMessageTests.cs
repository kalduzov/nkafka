...
public class DescribeGroupsResponseMessageTests: ResponseMessageTests<DescribeGroupsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeGroupsResponseMessage' message")]
    ...
    {
        var message = new DescribeGroupsResponseMessage
        {
        };
