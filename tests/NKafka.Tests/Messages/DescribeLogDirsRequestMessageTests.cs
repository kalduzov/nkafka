...
public class DescribeLogDirsRequestMessageTests: RequestMessageTests<DescribeLogDirsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeLogDirsRequestMessage' message")]
    ...
    {
        var message = new DescribeLogDirsRequestMessage
        {
        };
