...
public class DescribeLogDirsResponseMessageTests: ResponseMessageTests<DescribeLogDirsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'DescribeLogDirsResponseMessage' message")]
    ...
    {
        var message = new DescribeLogDirsResponseMessage
        {
        };
