...
public class ElectLeadersRequestMessageTests: RequestMessageTests<ElectLeadersRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ElectLeadersRequestMessage' message")]
    ...
    {
        var message = new ElectLeadersRequestMessage
        {
        };
