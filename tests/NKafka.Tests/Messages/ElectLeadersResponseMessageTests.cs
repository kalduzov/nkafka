...
public class ElectLeadersResponseMessageTests: ResponseMessageTests<ElectLeadersResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ElectLeadersResponseMessage' message")]
    ...
    {
        var message = new ElectLeadersResponseMessage
        {
        };
