...
public sealed partial class EndQuorumEpochRequestMessageTests: RequestMessageTests<EndQuorumEpochRequestMessage>
{
    [Fact(DisplayName = "Check serialize and deserialize 'EndQuorumEpochRequestMessage' message by Version0")]
