...
public class EndTxnRequestMessageTests: RequestMessageTests<EndTxnRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'EndTxnRequestMessage' message")]
