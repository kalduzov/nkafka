...
public class EndTxnResponseMessageTests: ResponseMessageTests<EndTxnResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'EndTxnResponseMessage' message")]
