...
public class FetchRequestMessageTests: RequestMessageTests<FetchRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'FetchRequestMessage' message")]
