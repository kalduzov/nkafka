...
public class FetchResponseMessageTests: ResponseMessageTests<FetchResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'FetchResponseMessage' message")]
    ...
    [InlineData(ApiVersions.Version9)]
    [InlineData(ApiVersions.Version10)]
    [InlineData(ApiVersions.Version11)]
    [InlineData(ApiVersions.Version12)]
    [InlineData(ApiVersions.Version13)]
