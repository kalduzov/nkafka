...
public class FetchSnapshotRequestMessageTests: RequestMessageTests<FetchSnapshotRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'FetchSnapshotRequestMessage' message")]
