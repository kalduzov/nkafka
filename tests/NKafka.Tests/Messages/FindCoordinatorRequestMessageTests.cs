...
public class FindCoordinatorRequestMessageTests: RequestMessageTests<FindCoordinatorRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'FindCoordinatorRequestMessage' message")]
