...
public class FindCoordinatorResponseMessageTests: ResponseMessageTests<FindCoordinatorResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'FindCoordinatorResponseMessage' message")]
