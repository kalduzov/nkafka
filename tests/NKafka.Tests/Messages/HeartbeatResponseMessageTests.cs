...
public class HeartbeatResponseMessageTests: ResponseMessageTests<HeartbeatResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'HeartbeatResponseMessage' message")]
    ...
    {
        var message = new HeartbeatResponseMessage
        {
        };
