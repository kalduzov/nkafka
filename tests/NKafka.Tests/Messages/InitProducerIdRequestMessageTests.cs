...
public class InitProducerIdRequestMessageTests: RequestMessageTests<InitProducerIdRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'InitProducerIdRequestMessage' message")]
