...
public class InitProducerIdResponseMessageTests: ResponseMessageTests<InitProducerIdResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'InitProducerIdResponseMessage' message")]
