...
public class JoinGroupRequestMessageTests: RequestMessageTests<JoinGroupRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'JoinGroupRequestMessage' message")]
