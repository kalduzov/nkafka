...
public class JoinGroupResponseMessageTests: ResponseMessageTests<JoinGroupResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'JoinGroupResponseMessage' message")]
