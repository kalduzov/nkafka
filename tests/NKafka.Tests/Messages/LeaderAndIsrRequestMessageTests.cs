...
public class LeaderAndIsrRequestMessageTests: RequestMessageTests<LeaderAndIsrRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'LeaderAndIsrRequestMessage' message")]
    ...
    {
        var message = new LeaderAndIsrRequestMessage
        {
        };
