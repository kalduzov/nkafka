...
public class LeaveGroupRequestMessageTests: RequestMessageTests<LeaveGroupRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'LeaveGroupRequestMessage' message")]
