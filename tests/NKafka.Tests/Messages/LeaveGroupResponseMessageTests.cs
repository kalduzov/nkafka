...
public class LeaveGroupResponseMessageTests: ResponseMessageTests<LeaveGroupResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'LeaveGroupResponseMessage' message")]
    ...
    {
        var message = new LeaveGroupResponseMessage
        {
        };
