...
public class ListGroupsRequestMessageTests: RequestMessageTests<ListGroupsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ListGroupsRequestMessage' message")]
