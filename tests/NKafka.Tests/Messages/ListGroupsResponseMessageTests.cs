...
public class ListGroupsResponseMessageTests: ResponseMessageTests<ListGroupsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ListGroupsResponseMessage' message")]
