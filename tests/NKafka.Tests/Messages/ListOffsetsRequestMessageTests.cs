...
public class ListOffsetsRequestMessageTests: RequestMessageTests<ListOffsetsRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ListOffsetsRequestMessage' message")]
