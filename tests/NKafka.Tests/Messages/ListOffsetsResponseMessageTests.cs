...
public class ListOffsetsResponseMessageTests: ResponseMessageTests<ListOffsetsResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ListOffsetsResponseMessage' message")]
