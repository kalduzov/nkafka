...
public class MetadataRequestMessageTests: RequestMessageTests<MetadataRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'MetadataRequestMessage' message")]
