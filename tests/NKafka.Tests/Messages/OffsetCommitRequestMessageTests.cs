...
public class OffsetCommitRequestMessageTests: RequestMessageTests<OffsetCommitRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'OffsetCommitRequestMessage' message")]
