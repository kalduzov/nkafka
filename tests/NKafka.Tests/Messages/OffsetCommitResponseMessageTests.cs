...
public class OffsetCommitResponseMessageTests: ResponseMessageTests<OffsetCommitResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'OffsetCommitResponseMessage' message")]
