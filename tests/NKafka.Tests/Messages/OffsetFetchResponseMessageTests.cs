...
public class OffsetFetchResponseMessageTests: ResponseMessageTests<OffsetFetchResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'OffsetFetchResponseMessage' message")]
