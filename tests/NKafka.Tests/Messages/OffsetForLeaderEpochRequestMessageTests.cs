...
public class OffsetForLeaderEpochRequestMessageTests: RequestMessageTests<OffsetForLeaderEpochRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'OffsetForLeaderEpochRequestMessage' message")]
