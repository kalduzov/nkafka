...
public class OffsetForLeaderEpochResponseMessageTests: ResponseMessageTests<OffsetForLeaderEpochResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'OffsetForLeaderEpochResponseMessage' message")]
