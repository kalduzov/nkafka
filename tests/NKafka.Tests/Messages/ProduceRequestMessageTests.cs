...
public class ProduceRequestMessageTests: RequestMessageTests<ProduceRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ProduceRequestMessage' message")]
