...
public class ProduceResponseMessageTests: ResponseMessageTests<ProduceResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'ProduceResponseMessage' message")]
