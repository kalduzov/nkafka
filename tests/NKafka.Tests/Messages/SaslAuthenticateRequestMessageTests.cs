...
public class SaslAuthenticateRequestMessageTests: RequestMessageTests<SaslAuthenticateRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'SaslAuthenticateRequestMessage' message")]
