...
public class StopReplicaRequestMessageTests: RequestMessageTests<StopReplicaRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'StopReplicaRequestMessage' message")]
    ...
    {
        var message = new StopReplicaRequestMessage
        {
        };
