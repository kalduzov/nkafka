...
public class StopReplicaResponseMessageTests: ResponseMessageTests<StopReplicaResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'StopReplicaResponseMessage' message")]
    ...
    {
        var message = new StopReplicaResponseMessage
        {
        };
