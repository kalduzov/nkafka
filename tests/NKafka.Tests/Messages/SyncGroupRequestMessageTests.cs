...
public class SyncGroupRequestMessageTests: RequestMessageTests<SyncGroupRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'SyncGroupRequestMessage' message")]
    ...
    {
        var message = new SyncGroupRequestMessage
        {
        };
