...
public class SyncGroupResponseMessageTests: ResponseMessageTests<SyncGroupResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'SyncGroupResponseMessage' message")]
    ...
    {
        var message = new SyncGroupResponseMessage
        {
        };
