...
public class TxnOffsetCommitRequestMessageTests: RequestMessageTests<TxnOffsetCommitRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'TxnOffsetCommitRequestMessage' message")]
