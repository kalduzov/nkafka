...
public class TxnOffsetCommitResponseMessageTests: ResponseMessageTests<TxnOffsetCommitResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'TxnOffsetCommitResponseMessage' message")]
