...
public sealed partial class UnregisterBrokerRequestMessageTests: RequestMessageTests<UnregisterBrokerRequestMessage>
{
    [Fact(DisplayName = "Check serialize and deserialize 'UnregisterBrokerRequestMessage' message by Version0")]
