...
public class UpdateMetadataRequestMessageTests: RequestMessageTests<UpdateMetadataRequestMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'UpdateMetadataRequestMessage' message")]
    ...
    {
        var message = new UpdateMetadataRequestMessage
        {
        };
