...
public class UpdateMetadataResponseMessageTests: ResponseMessageTests<UpdateMetadataResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'UpdateMetadataResponseMessage' message")]
    ...
    {
        var message = new UpdateMetadataResponseMessage
        {
        };
