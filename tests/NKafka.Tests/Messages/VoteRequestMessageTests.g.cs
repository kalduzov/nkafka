...
public sealed partial class VoteRequestMessageTests: RequestMessageTests<VoteRequestMessage>
{
    [Fact(DisplayName = "Check serialize and deserialize 'VoteRequestMessage' message by Version0")]
