...
public class VoteResponseMessageTests: ResponseMessageTests<VoteResponseMessage>
{
    [Theory(DisplayName = "Check serialize and deserialize 'VoteResponseMessage' message")]
