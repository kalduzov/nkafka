...
public class DoubleSerializationTests
{
    ...
    [InlineData(double.MaxValue, "7FF0000000000000")]
    public async Task SerializeAsync_Successful(float value, string serializeValueAsByteString)
    {
    ...
    [InlineData(0, "0000000000000000")]
    [InlineData(double.MaxValue, "7FF0000000000000")]
    public void Serialize_Successful(float value, string serializeValueAsByteString)
    {
        var serializeValue = Convert.FromHexString(serializeValueAsByteString);
        var serializer = new DoubleSerializer();
