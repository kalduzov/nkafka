...
public class LongSerializerTests
{
    ...
    public async Task SerializeAsync_Successful(long value, string serializeValueAsByteString)
    {
    ...
    [InlineData(long.MaxValue, "7FFFFFFFFFFFFFFF")]
    [InlineData(long.MinValue, "8000000000000000")]
    public void Serialize_Successful(long value, string serializeValueAsByteString)
    {
        var serializeValue = Convert.FromHexString(serializeValueAsByteString);
        var serializer = new LongSerializer();
